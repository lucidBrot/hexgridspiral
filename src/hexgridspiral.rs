...
impl HGSTile {
    fn new(tile_index: TileIndex) -> Self {
        return Self {
            h: tile_index,
...
impl CCTile {
    ...
    fn rot60ccw(&self) -> CCTile {CCTile::from_qrs(-self.s, -self.q, -self.r)}
    /// Rotate 60 degrees clockwise
    /// https://www.redblobgames.com/grids/hexagons/#rotation
    fn rot60cw(&self) -> CCTile {CCTile::from_qrs(-self.r, -self.s, -self.q)}
